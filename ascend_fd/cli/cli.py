...
def command_line():
    ...
    parse_cmd.add_argument("-i", "--input_path", type=str, required=True, metavar='',
                           help="the input path of origin data file")
    parse_cmd.add_argument("-o", "--output_path", type=str, required=True, metavar='',
                           help="the output path of parsed data file")

    diag_cmd = sub_arg.add_parser("diag", help="diag parsed log files")
    diag_cmd.add_argument("-i", "--input_path", type=str, required=True, metavar='',
                          help="the input path of parsed data file")
    diag_cmd.add_argument("-o", "--output_path", type=str, required=True, metavar='',
                          help="the output path of diag result file")
    diag_cmd.add_argument("-m", "--mode", type=int, default=0, choices=[0, 1], metavar='',
